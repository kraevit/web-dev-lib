/*
49-Global-vs-Local-Scope-in-Functions.js

It is possible to have both local and global variables with the same
name. When you do this, the local variable takes precedence over the
global variable.
...
Instructions
Add a local variable to myOutfit to override the value
