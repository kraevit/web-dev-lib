/*
46-Passing-Values-to-Functions-with-Arguments.js
...
that are input (or "passed") into a function when it is called are known
as arguments.
...
We have passed two arguments, "Hello" and "World". Inside the function, param1
 will equal "Hello" and param2 will equal "World". Note that you could call
 testFun again with different arguments and the parameters would take on the
 value of the new arguments.
